...
while True:
    ...
    Canvas_l, Canvas_c, Canvas_p = numpy.shape(Canvas)
    total_w = frame_c+Canvas_c
    total_h = frame_l
    ...
    output[0:total_h, frame_c:total_w, :] = Canvas[:, :, 0:3]

    cv.imshow("Point&Draw", output)  # Show the output
